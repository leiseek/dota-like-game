export type SelectionProfile = Readonly<{
  role: string;
  summary: string;
  special: string;
  tips: string;
...
export type EnemyStatusBadge = Readonly<{ text: string; color: string }>;
export type EnemyStatusType = "slow" | "stun" | "poison" | "burn";
...
const STATUS_LABELS: Record<EnemyStatusType, EnemyStatusBadge> = {
...
export function heroName(archetype: string): string {
  return HERO_DISPLAY_NAMES[archetype] ?? archetype;
}

export function enemyName(archetype: string): string {
  return ENEMY_DISPLAY_NAMES[archetype] ?? archetype;
}

export function heroProfile(archetype: string): SelectionProfile {
...
export function enemyProfile(archetype: string): SelectionProfile {
...
export function statusBadgeFor(statusType: EnemyStatusType): EnemyStatusBadge {
  return STATUS_LABELS[statusType];
}

export function statusEffectName(statusType: EnemyStatusType): string {
